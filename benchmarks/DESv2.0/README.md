# DynEarthSol v2.0 Benchmarks

This directory contains the benchmarks used to produce the results reported in the paper. Three benchmark sets are provided, each with a dedicated `README.md` with full reproduction instructions.
