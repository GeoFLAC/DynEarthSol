...
BENCHMARK_CASES: tuple[BenchmarkCase, ...] = (
    ...
    BenchmarkCase("steady_ab_pos_v0_1e-6", "steady_ab_pos", "elasto-plastic-rsf", 30.0, 0.2, 0.1, 1e-3, 1e-6, 0),
    BenchmarkCase("steady_ab_pos_v0_1e-5", "steady_ab_pos", "elasto-plastic-rsf", 30.0, 0.2, 0.1, 1e-3, 1e-5, 0),
    BenchmarkCase("steady_ab_pos_v0_1e-4", "steady_ab_pos", "elasto-plastic-rsf", 30.0, 0.2, 0.1, 1e-3, 1e-4, 0),
    BenchmarkCase("steady_ab_neg_v0_1e-6", "steady_ab_neg", "elasto-plastic-rsf", 30.0, 0.2, 0.3, 1e-3, 1e-6, 0),
    BenchmarkCase("steady_ab_neg_v0_1e-5", "steady_ab_neg", "elasto-plastic-rsf", 30.0, 0.2, 0.3, 1e-3, 1e-5, 0),
    BenchmarkCase("steady_ab_neg_v0_1e-4", "steady_ab_neg", "elasto-plastic-rsf", 30.0, 0.2, 0.3, 1e-3, 1e-4, 0),
    BenchmarkCase("aging_ab_neg_dc_1e-6", "aging_ab_neg", "elasto-plastic-rsf", 30.0, 0.2, 0.3, 1e-6, 1e-5, 1),
    BenchmarkCase("aging_ab_neg_dc_1e-5", "aging_ab_neg", "elasto-plastic-rsf", 30.0, 0.2, 0.3, 1e-5, 1e-5, 1),
    BenchmarkCase("aging_ab_neg_dc_1e-4", "aging_ab_neg", "elasto-plastic-rsf", 30.0, 0.2, 0.3, 1e-4, 1e-5, 1),
)
