...
* [LLVM](https://github.com/llvm/llvm-project) OpenMP library for macOS requires special setup due to Apple Clang lacking built-in OpenMP.
  * Run from the DynEarthSol directory:
    ```bash
    # Install default version (19.1.7) — downloads LLVM source from GitHub and builds into external/openmp-install/
    make openmp-install

    # Or install a specific version
    make openmp-install OPENMP_VERSION=18.1.8
    ```
