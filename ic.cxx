                                 ...
                                 double_vec &radiogenic_source, MarkerSet &ms, int_vec2D &elemmarkers, int_vec2D& markers_in_elem)
{
    ...
    double wx_r = 1./param.ic.rh_dome_width;

#ifdef THREED
    double az = param.ic.rh_dome_azimuth * DEG2RAD;
    double wy_r;
    if (param.ic.rh_dome_width_y == 0) {
        wy_r = 1./param.ic.rh_dome_width;
    } else if (param.ic.rh_dome_width_y < 0.0) {
        wy_r = 0.;
    } else {
        wy_r = 1./param.ic.rh_dome_width_y;
    }
#endif
    ...
    for (int n=0;n<var.nnode;n++) {
        ...
        double radius_sq;
        double dx = p[0] - param.ic.rh_dome_center_x * param.mesh.xlength;
#ifdef THREED
        double dy = p[1] - param.ic.rh_dome_center_y * param.mesh.ylength;
        ...
        const double xsfh = param.ic.surface_heat_flux + param.ic.rh_dome_amplitude / 1e6 * exp(-radius_sq);
